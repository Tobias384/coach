...
class User extends DataClass implements Insertable<User> {
  ...
  @override
  int get hashCode => Object.hash(id, username, email, restrictions, createdAt);
  @override
...
class Exercise extends DataClass implements Insertable<Exercise> {
  ...
  @override
  int get hashCode => Object.hash(id, name, category, targetMuscles, equipment);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Exercise &&
...
class WorkoutSession extends DataClass implements Insertable<WorkoutSession> {
  ...
  @override
  int get hashCode => Object.hash(id, userId, routineId, startTime, endTime);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class SetEntry extends DataClass implements Insertable<SetEntry> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, sessionId, exerciseId, weight, reps, performedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SetEntry &&
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({routineExercisesRefs = false, setEntriesRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
...
typedef $$ExercisesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (Exercise, $$ExercisesTableReferences),
      Exercise,
      PrefetchHooks Function({bool routineExercisesRefs, bool setEntriesRefs})
    >;
    ...
    $WorkoutSessionsTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({userId = false, routineId = false, setEntriesRefs = false}) {
                return PrefetchHooks(
                  db: db,
...
typedef $$WorkoutSessionsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (WorkoutSession, $$WorkoutSessionsTableReferences),
      WorkoutSession,
      PrefetchHooks Function({bool userId, bool routineId, bool setEntriesRefs})
    >;
